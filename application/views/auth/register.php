...
<body style="background:linear-gradient(to bottom, #09D53E 10%, #000602 79%);">

	<div class="container">
		<div class="row justify-content-center" id="row">
			

			<div style="; padding-top:50px; padding-bottom:100px;" class="my-5 col-lg-6 ">
				<h3 style="color:#F6FBFC" class="text-center">Aplikasi Pengaduan Masyarakat</h3>
				<h4 style="color:#F6FBFC" class="text-center">Register</h4>
						...
						<form action="<?= base_url('auth/register'); ?>" method="post">
							...
							<div class="form-group">
								<?= form_error('nik', '<small class="text-light">', '</small>'); ?>
							...
							<div class="row">
								...
								<div class="form-group col-sm-6">
									<?= form_error('repassword', '<small class="text-light">', '</small>'); ?>
									<input type="password" name="repassword" class="form-control" placeholder="Ulangi Password" id="form" autocomplete="off">
								</div>
							</div>

							<button type="submit" id="btn" class="btn bg-success">Register</button>
							<p style="color:#F6FBFC" class="text-center mt-2">Sudah punya akun, <a style="color:#33cc33" href="<?= base_url('auth'); ?>">Login</a> Sekarang</p>
						</form>
					</div>
				</div>
			</div>
